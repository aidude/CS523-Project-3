...
configfile='/nfs/student/s/spawar/Music/iAnt-ARGoS/experiments/homemade.argos'
basedatafile='/nfs/student/s/spawar/Music/iAnt-ARGoS/iAntTagData.txt'
myfile='/nfs/student/s/spawar/Music/iAnt-ARGoS/iAntData.txt'
gen_file='/nfs/student/s/spawar/Music/iAnt-ARGoS/iAnt_gen_Data.txt'
...
# runing ARGoS simulator vie python terminal
    ...
    for i in range(0,5):
        ...
        os.chdir("/nfs/student/s/spawar/Music/iAnt-ARGoS")
